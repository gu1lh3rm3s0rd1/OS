...
<table>
  ...
  <?php
    try{
      ...
      CASE WHEN data_prevista IS NULL THEN 'ABERTA' ELSE 'EM EXECUCAO' END as status, CONCAT((CURRENT_DATE - data_solicitacao), ' DIAS') as tempo
      FROM form_manut
     ...
     echo '<tr>';
     if ($status == 'ABERTA') {
        echo '<td class="naoconcluida" style="padding: 10px 0px;">'.$num_solicit.'</td>';
        //echo '<td class="naoconcluida">'.$num_equipamento.'</td>';
        //echo '<td class="naoconcluida" style="padding: 10px 0px;">'.$equipamento.'</td>';
        echo '<td class="naoconcluida" style="padding: 10px 10px;">'.$setor.'</td>';
        echo '<td class="naoconcluida" style="padding: 10px 10px;">'.$tipo.'</td>';
        //echo '<td class="naoconcluida" style="padding: 10px 0px;">'.$prioridade.'</td>';
        echo '<td class="naoconcluida" style="padding: 10px 10px;">'.$status.'</td>';
        echo '<td class="naoconcluida" style="padding: 10px 0px;">'.$dt_solicit.'</td>';
        echo '<td class="naoconcluida" style="padding: 10px 0px;">'.$tempo.'</td>';
      ...
      echo '<td class="andamento" style="padding: 10px 10px;">'.$status.'</td>';
