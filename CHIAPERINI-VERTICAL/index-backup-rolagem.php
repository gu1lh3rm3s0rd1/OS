...
<head>
  ...
  <meta http-equiv="refresh" content="15; http://192.168.1.135/FORMS/MANUTENCAO/CHIAPERINI2/index.php">
...
<script type="text/javascript">
      ...
      i = 0;
      tempo = 50;
      tamanho = 226; // tamanho da barra de rolagem  >> Ver arquivo Leiame.txt

      function Rolar() {
        document.getElementById('painel1').scrollTop = i;
        i++;
...
<div class="rotacione" id="painel0" style="font: 15px Tahoma; cursor: default; height: 100px; width: 100px; overflow: hidden;"onmouseout="Rolar()">
  <table class="table1">
  <tr>
    <th>00000</th>
    <th>00000</th>
...
<div onload="Rolar()" class="rotacione position0" id="painel1" style="font: 15px Tahoma; cursor: default; height: 200px; width: 100%; overflow: hidden;" onmouseover="Parar()" onmouseout="Rolar()">
